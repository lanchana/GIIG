angular
  .module('GiiG')
  .controller('ApplicantsShowController', ApplicantsShowController);

ApplicantsShowController.$inject = ['$stateParams', 'applicantService', 'jobsService', 'locationsService'];

function ApplicantsShowController($stateParams, applicantService, jobsService, locationsService) {
  var vm = this;
